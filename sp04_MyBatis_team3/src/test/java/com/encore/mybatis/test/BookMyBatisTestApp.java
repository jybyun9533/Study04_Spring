...
public class BookMyBatisTestApp {
	public static void main(String[] args) throws Exception {
		...
		ApplicationContext context = new ClassPathXmlApplicationContext(new String[] { "/config/userservice.xml" });
...
//		
		...
		vo = bookService.getBook(vo.getIsbn());

		BookDAO bookDAO = (BookDAO) context.getBean("bookDAOImpl");
		bookDAO.removeBook(vo.getIsbn());
